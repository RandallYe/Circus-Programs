...
\begin{zed}
	Analyser\_Analyse\_fOp \defs [~  \Xi Analyser\_AnalyserState ; Analyser\_signals? : \power InputSignal ; Analyser\_pumpCtrState? : PumpIndex \fun InputPCState ; Analyser\_v? : NUMS ; Analyser\_failureacks? : \power UnitFailure ; Analyser\_pumpState? : PumpIndex \fun InputPState ; Analyser\_repairs? : \power UnitFailure ; Analyser\_q? : NUMS ; \Xi Timer\_TimeState ; \Xi Controller\_ModeState ; \Xi Reporter\_ReporterState | \lnot \pre Analyser\_Analyse  ~]
\end{zed}
...
\begin{zed}
	Reporter\_AssgnOp15 \defs [~  \Delta Reporter\_ReporterState ; m? : Nonemergency ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_mode' = m? \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp16 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_signals' = Reporter\_signals \cup \{ programReady \} \land Reporter\_mode' = Reporter\_mode \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp17 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_pumpState' = PumpIndex \cross \{ popen \} \land Reporter\_mode' = Reporter\_mode \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp18 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_pumpState' = PumpIndex \cross \{ pclosed \} \land Reporter\_mode' = Reporter\_mode \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp19 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_signals' = Reporter\_signals \cup \{ openValve \} \land Reporter\_valveSt' = openv \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp20 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_signals' = Reporter\_signals \cup \{ closeValve \} \land Reporter\_valveSt' = closev \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp21 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_mode' = emergencyStop \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals  ~]
\end{zed}
