...
\begin{zed}
	Analyser\_SetValveState \defs [~  \Delta Analyser\_Valve ; vstate? : VStateAct | ( vstate? = VNoChange \implies Analyser\_valve' = Analyser\_valve ) \land ( vstate? = openv \implies Analyser\_valve' = vopen ) \land ( vstate? = closev \implies Analyser\_valve' = vclosed )  ~]
\end{zed}
...
\begin{zed}
	Reporter\_ReporterState \defs [~  Reporter\_OutputMsg ; Reporter\_valveSt : VStateAct | true  ~]
\end{zed}
...
\begin{zed}
	Timer\_InitTimer \defs [~  Timer\_TimeState' | Timer\_time' = Timer\_cyclelimit  ~]
\end{zed}
...
\begin{zed}
	Analyser\_InitAnalyserState \defs [~  Analyser\_AnalyserState' | Analyser\_InitEquipment \land Analyser\_stops' = 0 \land Analyser\_signalhistory' =~\emptyset \land \theta Analyser\_InputMsg' = ((( \LET Analyser\_signals ==~\emptyset ; Analyser\_pumpState == \{ 1 \mapsto pclosed , 2 \mapsto pclosed , 3 \mapsto pclosed , 4 \mapsto pclosed \} ; Analyser\_pumpCtrState == \{ 1 \mapsto pcnoflow , 2 \mapsto pcnoflow , 3 \mapsto pcnoflow , 4 \mapsto pcnoflow \} ; Analyser\_q == 0 ; Analyser\_v == 0 ; Analyser\_failureacks ==~\emptyset ; Analyser\_repairs ==~\emptyset @ \theta Analyser\_InputMsg ))) \land Analyser\_emergencyCond' = 0  ~]
\end{zed}
...
\begin{zed}
	SchExpr\_2\_fOp \defs [~  \Xi Analyser\_AnalyserState ; Analyser\_pumpState? : PumpIndex \fun InputPState ; Analyser\_pumpCtrState? : PumpIndex \fun InputPCState ; \Xi Timer\_TimeState ; \Xi Controller\_ModeState ; \Xi Reporter\_ReporterState | \lnot \pre SchExpr\_2  ~]
\end{zed}

\begin{zed}
	Analyser\_Analyse\_fOp \defs [~  \Xi Analyser\_AnalyserState ; Analyser\_q? : NUMS ; Analyser\_v? : NUMS ; Analyser\_pumpCtrState? : PumpIndex \fun InputPCState ; Analyser\_signals? : \power InputSignal ; Analyser\_failureacks? : \power UnitFailure ; Analyser\_pumpState? : PumpIndex \fun InputPState ; Analyser\_repairs? : \power UnitFailure ; \Xi Timer\_TimeState ; \Xi Controller\_ModeState ; \Xi Reporter\_ReporterState | \lnot \pre Analyser\_Analyse  ~]
\end{zed}

\begin{zed}
	Analyser\_SetExpectedPumpState\_fOp \defs [~  \Xi Analyser\_AnalyserState ; vstate? : VStateAct ; pumpstate? : PumpIndex \fun InputPState ; \Xi Timer\_TimeState ; \Xi Controller\_ModeState ; \Xi Reporter\_ReporterState | \lnot \pre Analyser\_SetExpectedPumpState  ~]
\end{zed}

\begin{zed}
	Controller\_InitController \defs [~  Controller\_ModeState' | Controller\_mode' = initialisation  ~]
\end{zed}
...
\begin{zed}
	Reporter\_OP\_valveSt \defs [~  \Xi Reporter\_ReporterState ; Reporter\_valveSt! : VStateAct ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_valveSt! = Reporter\_valveSt  ~]
\end{zed}
...
\begin{zed}
	Reporter\_AssgnOp15 \defs [~  \Delta Reporter\_ReporterState ; m? : Nonemergency ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_mode' = m? \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp16 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_signals' = Reporter\_signals \cup \{ programReady \} \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp17 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_pumpState' = PumpIndex \cross \{ popen \} \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp18 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_pumpState' = PumpIndex \cross \{ pclosed \} \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}

\begin{zed}
	Reporter\_AssgnOp19 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_signals' = Reporter\_signals \cup \{ openValve \} \land Reporter\_valveSt' = openv \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_mode' = Reporter\_mode \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}
...
\begin{zed}
	Reporter\_AssgnOp21 \defs [~  \Delta Reporter\_ReporterState ; \Xi Timer\_TimeState ; \Xi Analyser\_AnalyserState ; \Xi Controller\_ModeState | Reporter\_mode' = emergencyStop \land Reporter\_pumpCtrFailureDetection' = Reporter\_pumpCtrFailureDetection \land Reporter\_pumpRepairedAcknowledgement' = Reporter\_pumpRepairedAcknowledgement \land Reporter\_pumpState' = Reporter\_pumpState \land Reporter\_valveSt' = Reporter\_valveSt \land Reporter\_pumpFailureDetection' = Reporter\_pumpFailureDetection \land Reporter\_signals' = Reporter\_signals \land Reporter\_pumpCtrRepairedAcknowledgement' = Reporter\_pumpCtrRepairedAcknowledgement  ~]
\end{zed}
